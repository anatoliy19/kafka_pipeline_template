package org.example.kafka_template.camel.route;
...
import org.example.kafka_template.camel.processor.KafkaProcessingBean;
import org.example.kafka_template.camel.processor.NullFieldsCheckingBean;
import org.example.kafka_template.dto.messageformat.KafkaRawHoData;
import org.springframework.stereotype.Component;

@Component
public class KafkaConsumeRouter2 extends RouteBuilder {
    ...
    public void configure() throws Exception {
        ...
        try (JacksonDataFormat kafkaRawHoDataFormat = new JacksonDataFormat(KafkaRawHoData.class)) {
            from(kafkaConsumerEndpoint)
                    ...
                    .log("TRUE >>> ${body}")
                    .bean(method(KafkaProcessingBean.class, "addKafkaRecordDto"))
                    .otherwise()
                    .log("FALSE >>> ${body}")
                    .stop()
                    .endChoice()
